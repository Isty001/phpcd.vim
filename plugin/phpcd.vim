...
let g:phpcd_root = get(g:, 'phpcd_root', '/')
let g:phpcd_php_cli_executable = get(g:, 'phpcd_php_cli_executable', 'php')
let g:phpcd_autoload_path = get(g:, 'phpcd_autoload_path', 'vendor/autoload.php')
let g:phpcd_need_update = get(g:, 'phpcd_need_update', 0)
let g:phpcd_disable_modifier = get(g:, 'phpcd_disable_modifier', 0)
